...
export function Why() {
  const items = [
    { icon: "piggy-bank", t: "Low, flat pricing", s: "€24/month if you are self-employed, €49/month for a company — we keep the books, with a qualified accountant on the file. There is no software-only plan and the price does not move with your volume. All fees exclude VAT." },
