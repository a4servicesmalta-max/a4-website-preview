...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const base = pageMetadata(
    ...
    "A4 Services Limited — licensed Malta accounting and audit firm. Managed bookkeeping from €24/mo self-employed and €49/mo for a company, including one bank account, plus VAT, payroll, audit and corporate services.",
  );
...
export default async function Home() {
  ...
  const accountingService = {
    ...
    description:
      "Licensed Malta accounting and audit firm — accounting, statutory audit, tax, VAT, payroll, fractional CFO and managed bookkeeping from €24/mo self-employed, €49/mo for a company, including one bank account.",
    priceRange: "€€",
