...
export const PARTNER_CRITERIA = [
  { icon: "award", t: "Professional standards", s: "Qualified, reputable firms that hold themselves to high professional and ethical standards." },
  { icon: "compass", t: "Strategic alignment", s: "A shared view of where the profession is heading and how technology should support it." },
  { icon: "gauge", t: "Operational capacity", s: "The capability and resourcing to deliver consistently for clients." },
  { icon: "users", t: "Cultural fit", s: "A client-first, transparent way of working that mirrors how A4 operates." },
  { icon: "map", t: "Market presence", s: "An established or growing presence in the markets and sectors we serve." },
  { icon: "scale", t: "Legal & compliance", s: "Sound legal standing and a clean compliance record in their jurisdiction." },
];
