...
export default function StickyConversionBar() {
  ...
  return (
    <div
      className="fixed bottom-24 right-4 sm:right-6 z-[95] flex flex-col items-end gap-2.5 pointer-events-none"
    ...
    >
      <a
        ...
        className="pointer-events-auto inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-black/20 transition-opacity hover:opacity-90"
      >
        <WhatsAppIcon />
        WhatsApp
      </a>
