...
export function LandingPlan() {
  ...
  // Required before anything is sent — it decides which months are catch-up.
  ...
  const lines = ([
    { k: `Managed bookkeeping — ${plan.name}`, v: base },
  ...
  // managed bookkeeping, and the managed price is flat.
  const monthlyAddons = ([
              ...
              <div>
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginTop: 6 }}>
                    <span style={{ fontFamily: "var(--a4-font-display)", fontWeight: 500, fontSize: 30, color: "var(--a4-ink)", letterSpacing: "-1px" }}>{lpEuro(base)}</span>
                  ...
                  <div style={{ marginTop: 16, paddingTop: 14, borderTop: "1px solid var(--a4-hairline-light)" }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: 10 }}>
                      {[0, 3, 6, 12, 24, 36].map((m) => {
                        ...
                        return (
                          <button key={m} type="button" onClick={() => setCatchUpMonths(m)} style={{
